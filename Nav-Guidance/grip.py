...
class GripPipelineTest:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [35, 76]
        self.__hsv_threshold_saturation = [50, 161]
        self.__hsv_threshold_value = [123, 255]
    ...
    def process(self, source0, hsv_hue_thresh = [15, 76], hsv_sat_thresh = [0, 80] ,hsv_val_thresh = [123, 255]):
        """
        ...
        # Step HSV_Threshold0:
        self.__hsv_threshold_input = self.blur_0_output
        (self.hsv_threshold_output) = self.__hsv_threshold(self.__hsv_threshold_input, hsv_hue_thresh, hsv_sat_thresh, hsv_val_thresh)
