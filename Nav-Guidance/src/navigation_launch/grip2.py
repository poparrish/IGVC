...
class GripPipelineTest:
	...
	chosen_config = "1130IGVC"
        ...
        self.__cv_addweighted_alpha = 1
        self.__cv_addweighted_src2 = self.hsv_threshold_output
        self.__cv_addweighted_beta = 1
        self.__cv_addweighted_gamma = 0
        ...
        self.__filter_contours_max_height = 1000000
